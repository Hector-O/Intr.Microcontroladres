...
; delay.asm
;
; Created: 09/03/2022 03:13:33 p. m.
; Author : hecth
;
...
main: sbis pind,5 ;si es 1 (Set) se brinca la siguiente instrucción, si no continúa con ella
	...
	; o usar esto->
	;in temp, pind ;se lee del puerto d
	;andi temp, $20 ;s�lo seleccionamos el bit 5, si tiene 1 se queda el uno, si tiene 0 se queda el cero, y lo dem�s no importa
	;breq un_seg ; si resultado (bandera Z) es igual a 0, salta a un_seg si no sigue a dos_seg
