...
; no_se.asm
;
; Created: 09/05/2022 04:42:25 p. m.
; Author : hecth
;


; Replace with your application code	.def temp=r16
	.def temp=r16
	.def cont1=r17
	.def cont2=r18
	.def cont3=r19
...
reset:	ldi temp, $01
	...
	ldi temp, $9c ; 0010 1000
	out portd, temp ;Enable 1 y RS en 1
	ldi temp, $94 ; 0010 0000
	out portd, temp ; Enable 0 y RS en 0
	call delay_10ms

	; letra P
	ldi temp, $5c ; 0010 1000
	out portd, temp ;Enable 1 y RS en 1
	ldi temp, $54 ; 0010 0000
	out portd, temp ; Enable 0 y RS en 1

	ldi temp, $0c ; 0010 1000
	out portd, temp ;Enable 1 y RS en 1
	ldi temp, $04 ; 0010 0000
	out portd, temp ; Enable 0 y RS en 0
	call delay_10ms
	...
	ldi temp, $ec ; 0010 1000
	out portd, temp ;Enable 1 y RS en 1
	ldi temp, $e4 ; 0010 0000
	out portd, temp ; Enable 0 y RS en 0
	call delay_10ms
